...
for(const file of pages){
 ...
 for(const lang of ['en','es']){
  ...
  const social=`<meta property="og:type" content="website"><meta property="og:site_name" content="Blue Quest"><meta property="og:title" content="${escape(title)}"><meta property="og:description" content="${description}"><meta property="og:url" content="${domain+route(file,lang)}"><meta property="og:locale" content="${lang==='es'?'es_ES':'en_GB'}"><meta property="og:image" content="${domain}/assets/hero/reef-survey.webp"><meta name="twitter:card" content="summary_large_image">`;
